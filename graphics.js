...
function DrawGrid() {
  ...
  // Draw the x axis
  svg.append("path")
  .attr("d", d3.line()([[svg_x_shift, svg_y_shift + grid_height], [svg_x_shift + grid_width, svg_y_shift + grid_height]]))
  .attr("stroke", "black")
  .attr("stroke-width", 2);

  // Draw x arrowhead
  svg.append("path")
  .attr("d", d3.line()([[svg_x_shift + grid_width + 10, svg_y_shift + grid_height], [svg_x_shift + grid_width - 5, svg_y_shift + grid_height - 5], [svg_x_shift + grid_width, svg_y_shift + grid_height], [svg_x_shift + grid_width - 5, svg_y_shift + grid_height + 5]]))
  .attr("stroke", "black")
  .attr("stroke-width", 2);

  // Draw the y axis
  svg.append("path")
  .attr("d", d3.line()([[svg_x_shift, svg_y_shift], [svg_x_shift, svg_y_shift + grid_height]]))
  .attr("stroke", "black")
  .attr("stroke-width", 2);

  // Draw y arrowhead
  svg.append("path")
  .attr("d", d3.line()([[svg_x_shift, svg_y_shift - 10], [svg_x_shift + 5, svg_y_shift + 5], [svg_x_shift, svg_y_shift], [svg_x_shift - 5, svg_y_shift + 5]]))
  .attr("stroke", "black")
  .attr("stroke-width", 2);
}
...
function AddArrow(cx1, cy1, cx2, cy2, color = "black") {
    ...
    let pathData = lineGenerator([{x: x1, y: y1}, {x: x2, y: y2}]);
...
function DrawNode(x, y, color = "#9999FF") {
  InsertCircleWithText(svg_x_shift + x * cell_size - cell_size / 2, svg_y_shift + grid_height - y * cell_size + cell_size / 2, x + ';' + y, color);
}

function UndrawNode(x, y) {
  DeleteCircleWithText(svg_x_shift + x * cell_size - cell_size / 2, svg_y_shift + grid_height - y * cell_size + cell_size / 2);
}
...
function DrawEdge(cx1, cy1, cx2, cy2, color = "black") {
  AddArrow(svg_x_shift + cx1 * cell_size - cell_size / 2, svg_y_shift + grid_height - cy1 * cell_size + cell_size / 2, svg_x_shift + cx2 * cell_size - cell_size / 2, svg_y_shift + grid_height - cy2 * cell_size + cell_size / 2, color);
}

function UndrawEdge(cx1, cy1, cx2, cy2) {
  DeleteArrow(svg_x_shift + cx1 * cell_size - cell_size / 2, svg_y_shift + grid_height - cy1 * cell_size + cell_size / 2, svg_x_shift + cx2 * cell_size - cell_size / 2, svg_y_shift + grid_height - cy2 * cell_size + cell_size / 2);
}
